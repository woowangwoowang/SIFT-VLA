...
# Blackwell GPUs (sm_120) require PyTorch wheels built with CUDA 12.8+.
RUN uv pip install --reinstall-package torch --reinstall-package torchvision --index-url https://download.pytorch.org/whl/cu128 torch==2.7.1 torchvision==0.22.1
